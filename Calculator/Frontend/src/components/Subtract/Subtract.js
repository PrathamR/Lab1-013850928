...
class Subtract extends Component{
    ...
    submitLogin = (e) => {
        ...
        axios.post('http://localhost:3006/subtract',data)
            .then(response => {
    ...
    render(){
        ...
        console.log("Rendering subtract");
        return(
            <div>
            <div class="container">
                ...
                <div class="login-form">
                    <div class="main-div">
                        <div class="panel">
                            <h2>Subtraction</h2>
                            <p>Enter operand 1 and 2. Click Subtract. </p>
                        </div>
                            ...
                            <button onClick = {this.submitLogin} class="btn btn-primary">Subtract</button>    
