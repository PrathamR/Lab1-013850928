...
class Divide extends Component{
    ...
    submitLogin = (e) => {
        ...
        axios.post('http://localhost:3006/divide',data)
            .then(response => {
            ...
            <div class="container">
                ...
                <div class="login-form">
                    <div class="main-div">
                        <div class="panel">
                            <h2>Division</h2>
                            <p>Enter operand 1 and 2. Click Divide. </p>
                        </div>
                            ...
                            <button onClick = {this.submitLogin} class="btn btn-primary">Divide</button>    
