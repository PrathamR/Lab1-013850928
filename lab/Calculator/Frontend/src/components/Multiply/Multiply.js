...
class Multiply extends Component{
    ...
    submitLogin = (e) => {
        ...
        axios.post('http://localhost:3006/multiply',data)
            .then(response => {
                ...
                <div class="login-form">
                    <div class="main-div">
                        <div class="panel">
                            ...
                            <p>Enter operand 1 and 2. Click Multiply. </p>
                        </div>
                            ...
                            <button onClick = {this.submitLogin} class="btn btn-primary">Multiply</button>    
